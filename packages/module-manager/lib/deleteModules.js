...
export default async function deleteModules(manifestObject) {
...
function deleteBackgroundScript(manifestObject) {
  if (manifestObject.background) {
    delete manifestObject.background;
  }
}
async function deleteContentScript(manifestObject) {
...
async function deleteContentScriptUI(manifestObject) {
...
async function deleteContentScriptRuntime(manifestObject) {
...
async function deleteNewTabOverride(manifestObject) {
...
async function deletePopup(manifestObject) {
...
async function deleteDevTools(manifestObject) {
...
async function deleteSidePanel(manifestObject) {
...
async function deleteOptionsPage(manifestObject) {
...
async function zipFolder(path, out) {
