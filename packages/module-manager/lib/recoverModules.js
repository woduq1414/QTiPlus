...
export default async function recoverModules(manifestObject) {
...
function recoverBackgroundScript(manifestObject) {
  manifestObject.background = {
    service_worker: 'background.js',
    type: 'module',
  };
}
function recoverContentScript(manifestObject) {
...
function recoverContentScriptUI(manifestObject) {
  if (!manifestObject.content_scripts) {
    manifestObject.content_scripts = [];
  }
  manifestObject.content_scripts.push({
...
function recoverContentScriptRuntime(manifestObject) {
  if (!manifestObject.content_scripts) {
    manifestObject.content_scripts = [];
  }
  manifestObject.content_scripts.push({
...
function recoverNewTabOverride(manifestObject) {
...
function recoverPopup(manifestObject) {
...
function recoverDevTools(manifestObject) {
...
function recoverSidePanel(manifestObject) {
...
function recoverOptionsPage(manifestObject) {
...
function upZipAndDelete(zipFilePath, destPath) {
